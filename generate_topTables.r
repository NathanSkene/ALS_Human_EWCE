...
source("/Users/ns9/Google Drive/EWCE_old/R/generate.bootstrap.plots.r")
source("/Users/ns9/Google Drive/EWCE_old/R/read_celltype_data.r")
source("/Users/ns9/Google Drive/EWCE_old/R/get_annot_below.r")
source("/Users/ns9/Google Drive/EWCE_old/R/bootstrap.enrichment.test.r")
source("/Users/ns9/Google Drive/EWCE_old/R/ewce.plot.r")
source("/Users/ns9/Google Drive/EWCE_old/R/merge_two_expfiles.r")
source("/Users/ns9/Google Drive/EWCE_old/R/ewce_expression_data.r")
source("/Users/ns9/Google Drive/EWCE_old/R/get_summed_proportions.r")
source("/Users/ns9/Google Drive/EWCE_old/R/cell.list.dist.r")

thresh=0#.00
trim=0.0
wtLEVELS="woLev"
sct_path = "/Users/ns9/Datasets that are too large to store elsewhere/SOD1 Spinal Cord (GSE18597)"
...
#save(ewce_spinal,file="EWCE_SPINAL.Rda")
...
source("/Users/ns9/Google Drive/EWCE/R/generate.bootstrap.plots.for.transcriptome.r")
#load("/Users/ns9/Datasets that are too large to store elsewhere/Disease Transcriptomes/ALS/EWCE_SPINAL.Rda")
...
#############################################################
library(limma)
path = "/Users/ns9/Datasets that are too large to store elsewhere/Disease Transcriptomes/ALS/"
setwd(path)
